 ...
 * @subpackage Image
 *
 * @author Mayurnikov Konstantin <clints@i.ua>
 * @copyright Solve Project, Alexandr Viniychuk
 * created: Dec 13, 2009 1:54:17 PM
 */

/**
 * ImageEngine for work throw GD library
 *
 * @version 1.0
 *
 * @author Mayurnikov Konstantin <clints@i.ua>
...
//        if diff by width > diff by height we`ll need to cut image from left/right sides
        if ($dwp > $dhp) {
